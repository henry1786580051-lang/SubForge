...
class TestSiliconFlowTTS:
    ...
    @patch("subforge.core.tts.siliconflow.requests.post")
...
class TestOpenAITTS:
    ...
    @patch("subforge.core.tts.openai_tts.OpenAI")
...
class TestOpenAIFmTTS:
    ...
    @patch("subforge.core.tts.openai_fm.requests.get")
