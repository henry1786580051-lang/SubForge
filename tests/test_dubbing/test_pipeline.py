...
from subforge.core.dubbing import DubbingConfig, DubbingPipeline
from subforge.core.speech import SynthesisResult
...
def test_dubbing_pipeline_creates_timeline_audio(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "subforge.core.dubbing.pipeline.create_speech_synthesizer",
...
def test_dubbing_pipeline_uses_configured_workers(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("subforge.core.dubbing.pipeline.ThreadPoolExecutor", CapturingExecutor)
