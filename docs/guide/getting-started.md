---
title: 快速开始 - SubForge
description: 快速安装和配置 SubForge，5分钟开始处理你的第一个视频字幕。支持 Windows、macOS、Linux 多平台。
head:
  - - meta
    - name: keywords
      content: SubForge安装,快速开始,视频字幕教程,Whisper安装,LLM配置,字幕处理入门
---

# 快速开始

本指南将帮助你快速上手 SubForge，开始处理你的第一个视频字幕。
...
::: tip 推荐
如果需要高并发和优质模型，可使用本项目的 [LLM API 中转站](https://api.subforge.cn)

配置方式：

- Base URL: `https://api.subforge.cn/v1`
- API Key: 注册后在个人中心获取
