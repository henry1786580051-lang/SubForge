...
访问 [本项目的中转站](https://api.subforge.cn/register?aff=UrLB)，通过此链接注册默认赠送 **$0.4** 测试余额。

#### 2. 获取 API Key

登录后访问 [https://api.subforge.cn/token](https://api.subforge.cn/token) 获取你的 API Key
...
| 配置项           | 值                                 |
| ---------------- | ---------------------------------- |
| **API 接口地址** | `https://api.subforge.cn/v1` |
| **API Key**      | 粘贴你获取的密钥                   |
| **模型**         | 见下方推荐                         |
