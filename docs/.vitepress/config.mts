...
export default defineConfig({
  ...
  transformHead({ pageData }) {
    const canonicalUrl = `https://henry1786580051-lang.github.io/SubForge/${pageData.relativePath}`
      .replace(/index\.md$/, '')
      .replace(/\.md$/, '')
    ...
    if (!pageData.relativePath.startsWith('en/')) {
      // 中文页面指向英文版本
      const enPath = `https://henry1786580051-lang.github.io/SubForge/en/${pageData.relativePath}`
        .replace(/index\.md$/, '')
        .replace(/\.md$/, '')
      head.push(
      ...
      // 英文页面指向中文版本
      const zhPath = `https://henry1786580051-lang.github.io/SubForge/${pageData.relativePath.replace('en/', '')}`
        .replace(/index\.md$/, '')
        .replace(/\.md$/, '')
      head.push(
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: 'SubForge,video subtitles,AI subtitles,automatic captions,视频字幕生成,自动字幕工具,Whisper subtitles,LLM translation,字幕翻译,subtitle optimization,语音识别,speech recognition,字幕错别字优化,视频处理,video processing,开源字幕软件,open source subtitle tool,卡卡字幕助手' }],
    ['meta', { name: 'author', content: 'henry1786580051-lang' }],
    ...
    ['meta', { property: 'og:title', content: 'SubForge - 基于LLM的智能视频字幕处理工具' }],
    ['meta', { property: 'og:description', content: '免费开源的AI视频字幕处理助手。支持Whisper语音识别、LLM智能断句与翻译、多语言字幕生成。适用于YouTube、B站等平台，支持99种语言。' }],
    ['meta', { property: 'og:site_name', content: 'SubForge' }],
    ['meta', { property: 'og:url', content: 'https://henry1786580051-lang.github.io/SubForge/' }],
    ['meta', { property: 'og:image', content: 'https://henry1786580051-lang.github.io/SubForge/logo.png' }],
    ['meta', { property: 'og:image:width', content: '1200' }],
    ['meta', { property: 'og:image:height', content: '630' }],
    ['meta', { property: 'og:image:alt', content: 'SubForge Logo' }],

    // Twitter Card（英文为主，面向国际用户）
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:site', content: '@SubForge' }],
    ['meta', { name: 'twitter:creator', content: '@henry1786580051-lang' }],
    ['meta', { name: 'twitter:title', content: 'SubForge - AI-Powered Video Subtitle Tool' }],
    ...
    ['meta', { name: 'twitter:image', content: 'https://henry1786580051-lang.github.io/SubForge/logo.png' }],
    ['meta', { name: 'twitter:image:alt', content: 'SubForge - AI Video Subtitle Tool' }],
      ...
      '@graph': [
        {
          ...
          '@id': 'https://henry1786580051-lang.github.io/SubForge/#software',
          name: 'SubForge',
          ...
          author: {
            '@type': 'Person',
            name: 'henry1786580051-lang',
            url: 'https://github.com/henry1786580051-lang'
          },
          aggregateRating: {
          ...
          url: 'https://henry1786580051-lang.github.io/SubForge/',
          downloadUrl: 'https://github.com/henry1786580051-lang/SubForge/releases',
          image: 'https://henry1786580051-lang.github.io/SubForge/logo.png',
        ...
        {
          '@type': 'WebSite',
          '@id': 'https://henry1786580051-lang.github.io/SubForge/#website',
          url: 'https://henry1786580051-lang.github.io/SubForge/',
          name: 'SubForge Documentation',
          description: 'SubForge 官方文档 - 视频字幕处理工具使用指南',
          publisher: {
            '@id': 'https://henry1786580051-lang.github.io/SubForge/#organization'
          },
          inLanguage: ['zh-CN', 'en-US'],
          potentialAction: {
            '@type': 'SearchAction',
            target: 'https://henry1786580051-lang.github.io/SubForge/?q={search_term_string}',
        ...
        },
        {
          ...
          logo: {
            '@type': 'ImageObject',
            url: 'https://henry1786580051-lang.github.io/SubForge/logo.png',
            width: 200,
            height: 200
          },
          sameAs: [
  ...
  // Sitemap 生成配置
  sitemap: {
    hostname: 'https://henry1786580051-lang.github.io/SubForge/',
    transformItems(items) {
      // 为不同类型页面设置不同的优先级和更新频率
      return items.map(item => {
        const url = item.url
        // 首页最高优先级 (exact match for homepage)
        if (url === 'https://henry1786580051-lang.github.io/SubForge/' ||
            url === 'https://henry1786580051-lang.github.io/SubForge/en/') {
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/henry1786580051-lang/SubForge' }
    ]
  },
  ...
  locales: {
    root: {
      ...
      themeConfig: {
        ...
        editLink: {
          pattern: 'https://github.com/henry1786580051-lang/SubForge/edit/master/docs/:path',
          text: '在 GitHub 上编辑此页'
        },

        footer: {
          message: '基于 GPL-3.0 许可发布',
          copyright: 'Copyright © 2024-present henry1786580051-lang'
        },
