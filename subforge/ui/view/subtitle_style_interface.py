...
from subforge.config import ASSETS_PATH, SUBTITLE_STYLE_PATH
from subforge.core.constant import INFOBAR_DURATION_SUCCESS, INFOBAR_DURATION_WARNING
from subforge.core.entities import SubtitleLayoutEnum, SubtitleRenderModeEnum
from subforge.core.subtitle import get_builtin_fonts, render_ass_preview, render_preview
from subforge.core.subtitle.style_manager import StyleMode
from subforge.core.subtitle.styles import RoundedBgStyle
from subforge.core.utils.platform_utils import open_folder
from subforge.ui.common.config import cfg
from subforge.ui.common.signal_bus import signalBus
from subforge.ui.components.MySettingCard import (
    ColorSettingCard,
    ComboBoxSettingCard,
...
class SubtitleStyleInterface(QWidget):
    ...
    def _refreshStyleList(self):
        ...
        # 获取匹配当前模式的 JSON 样式文件
        from subforge.core.subtitle.style_manager import style_id_from_filename
        style_files = []
    ...
    def _loadAssStyle(self, style_path: Path):
        """加载 ASS 样式 (.json)"""
        from subforge.core.subtitle.style_manager import SubtitleStyle
    ...
    def _saveAssStyle(self, style_path: Path):
        """保存 ASS 样式 (.json)"""
        from subforge.core.subtitle.style_manager import (
            SecondaryStyle,
            SubtitleStyle,
