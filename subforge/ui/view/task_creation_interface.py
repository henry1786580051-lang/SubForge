...
from subforge.config import APPDATA_PATH, ASSETS_PATH, VERSION
...
from subforge.ui.thread.video_download_thread import VideoDownloadThread
from subforge.ui.view.log_window import LogWindow
...
class TaskCreationInterface(QWidget):
    ...
    def setup_info_label(self):
        ...
        self.info_label = BodyLabel(
            self.tr(f"©SubForge {VERSION} • By Weifeng"), self
        )
