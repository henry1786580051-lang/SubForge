...
from subforge.config import AUTHOR, FEEDBACK_URL, HELP_URL, RELEASE_URL, VERSION, YEAR
from subforge.core.constant import (
    INFOBAR_DURATION_ERROR,
    INFOBAR_DURATION_SUCCESS,
    INFOBAR_DURATION_WARNING,
)
from subforge.core.entities import LLMServiceEnum, TranscribeModelEnum, TranslatorServiceEnum
from subforge.core.llm import check_whisper_connection
from subforge.core.llm.check_llm import check_llm_connection, get_available_models
from subforge.core.utils.cache import disable_cache, enable_cache
from subforge.ui.common.config import cfg
from subforge.ui.common.signal_bus import signalBus
from subforge.ui.components.EditComboBoxSettingCard import EditComboBoxSettingCard
from subforge.ui.components.LineEditSettingCard import LineEditSettingCard
...
class SettingInterface(ScrollArea):
    ...
    def __initCards(self):
        ...
        self.helpCard = HyperlinkCard(
            ...
            FIF.HELP,
            self.tr("帮助"),
            self.tr("发现新功能并了解有关SubForge的使用技巧"),
            self.aboutGroup,
        )
