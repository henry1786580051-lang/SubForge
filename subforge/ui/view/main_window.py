...
from subforge.config import ASSETS_PATH, GITHUB_REPO_URL
from subforge.core.constant import INFOBAR_DURATION_FOREVER
from subforge.ui.common.config import cfg
from subforge.ui.components.DonateDialog import DonateDialog
from subforge.ui.thread.version_checker_thread import VersionChecker
from subforge.ui.view.batch_process_interface import BatchProcessInterface
from subforge.ui.view.home_interface import HomeInterface
from subforge.ui.view.llm_logs_interface import LLMLogsInterface
from subforge.ui.view.setting_interface import SettingInterface
from subforge.ui.view.subtitle_style_interface import SubtitleStyleInterface
...
class MainWindow(FluentWindow):
    ...
    def switchTo(self, interface):
        if interface.windowTitle():
            ...
            self.setWindowTitle(self.tr("卡卡字幕助手 -- SubForge"))
    ...
    def onGithubDialog(self):
        ...
        w = MessageBox(
            self.tr("GitHub信息"),
            self.tr(
                "SubForge 由本人在课余时间独立开发完成，目前托管在GitHub上，欢迎Star和Fork。项目诚然还有很多地方需要完善，遇到软件的问题或者BUG欢迎提交Issue。\n\n https://github.com/WEIFENG2333/SubForge"
            ),
            self,
        )
