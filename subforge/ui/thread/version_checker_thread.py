...
from subforge.core.utils.cache import get_version_state_cache
...
class VersionChecker(QObject):
    ...
    def get_latest_version_info(self) -> dict:
        ...
        try:
            ...
            #     "update_info": "更新内容",
            #     "download_url": "https://github.com/WEIFENG2333/SubForge/releases/latest",
            #     "announcement": {
            #         "enabled": True,
            #         "content": "公告内容211",
    ...
    def check_new_version_announcement(self) -> None:
        ...
        if not self.cache.get(version_key, default=False):
            ...
            update_announcement = (
                f"Welcome to SubForge {self.current_version}\n\n"
                f"What's new:\n{self.update_info}"
            )
