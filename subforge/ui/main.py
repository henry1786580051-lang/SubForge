"""GUI entry point — launchable via `subforge` (no args) or `python -m subforge.ui.main`."""
...
def main():
    ...
    from subforge.config import TRANSLATIONS_PATH
    ...
    from subforge.ui.view.main_window import MainWindow
    ...
    my_translator.load(str(TRANSLATIONS_PATH / f"SubForge_{locale.name()}.qm"))
