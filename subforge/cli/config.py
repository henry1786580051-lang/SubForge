...
Config priority (highest to lowest):
  ...
  3. User config file (~/.config/subforge/config.toml)
  4. Built-in defaults
"""
...
ENV_MAP: Dict[str, str] = {
    ...
    "AZURE_TRANSLATOR_KEY": "translate.azure_key",
    "AZURE_TRANSLATOR_REGION": "translate.azure_region",
    "AZURE_TRANSLATOR_ENDPOINT": "translate.azure_endpoint",
    "VIDEOCAPTIONER_AZURE_TRANSLATOR_KEY": "translate.azure_key",
    "VIDEOCAPTIONER_AZURE_TRANSLATOR_REGION": "translate.azure_region",
    "VIDEOCAPTIONER_AZURE_TRANSLATOR_ENDPOINT": "translate.azure_endpoint",
...
def load_config_file(path: Optional[Path] = None) -> dict:
    ...
    try:
        ...
        print("  Run 'subforge config init' to recreate it.", file=sys.stderr)
        return {}
