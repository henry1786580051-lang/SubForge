...
def run(args: Namespace, config: dict) -> int:
    ...
    if is_url:
        ...
        output.hint("Download first: subforge download <url>")
        output.hint("Then: subforge process <downloaded_file>")
    ...
    from subforge.cli.validators import validate_dubbing, validate_process
    ...
    from subforge.cli.commands.transcribe import run as transcribe_run
    ...
    if not no_optimize or not no_translate:
        ...
        from subforge.cli.commands.subtitle import run as subtitle_run
    ...
    if do_dub:
        ...
        from subforge.cli.commands.dub import run as dub_run
    ...
    if not no_synthesize:
        ...
        from subforge.cli.commands.synthesize import run as synthesize_run
