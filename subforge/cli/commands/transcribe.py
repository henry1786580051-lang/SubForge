...
from subforge.cli.validators import validate_transcribe


def run(args: Namespace, config: dict) -> int:
    from subforge.cli.validators import validate_media_input
    ...
    from subforge.cli.validators import validate_output_format
    ...
    transcribe_config = TranscribeConfig(
        ...
        enable_audio_enhancement=get(config, "transcribe.audio_enhancement", True),
    ...
    try:
        ...
        from subforge.cli.validators import AUDIO_EXTENSIONS
        ...
        from subforge.core.asr import transcribe
