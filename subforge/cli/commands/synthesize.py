...
from subforge.cli.validators import validate_synthesize
...
def _resolve_style(config: dict, verbose: bool) -> tuple:
    ...
    if style is None:
        ...
        output.hint("Run 'subforge style' to see all options")
        return None, None, None, None, None
...
def run(args: Namespace, config: dict) -> int:
    ...
    from subforge.cli.validators import validate_video_input
    ...
    try:
        if soft:
            ...
            from subforge.core.utils.video_utils import add_subtitles
            add_subtitles(
            ...
            if mode == "rounded":
                ...
                from subforge.core.subtitle.rounded_renderer import render_rounded_video
                ...
                from subforge.core.asr.asr_data import ASRData
                from subforge.core.subtitle.ass_renderer import render_ass_video
                asr_data = ASRData.from_subtitle_file(str(subtitle_path))
...
def _register_font(font_file: str) -> None:
    ...
    from subforge.config import FONTS_PATH
