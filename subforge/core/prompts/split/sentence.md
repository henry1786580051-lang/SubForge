...
8. ${target_language_guidance}
9. 日语不得在连续片假名词或汉字复合词内部断开（如 トンネル、圧力），也不得拆开动词词干与活用语尾（如 掘 / った 或 掘っ / た）；格助词应与前面的名词短语同段，不得让下一段以 が、を、は、に、へ、で、の 等助词开头；属格 の、や、及び、または 等修饰或并列连接不得悬在前段末尾；掘ったトンネル、難しい工事、非常に難しい、抜いていくといった工事 等定语或副词结构必须保持完整；こちらのですね 等短小填充语应与后续实义短语同段
</instructions>
